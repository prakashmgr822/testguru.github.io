            ...
            <div class="row">
                ...
                <div class="col-md-12 col-offset-6 centered">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form repeater" id="form" action="{{ route('student.password.store') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control" required name="confirm_password" value="{{ old('confirm_password') }}">
                                    </div>
                                </div>
